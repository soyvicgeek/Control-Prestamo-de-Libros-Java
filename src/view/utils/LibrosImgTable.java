...
public class LibrosImgTable extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if (value instanceof String) {
            ...
            File archivo = new File("src/view/img/libros/" + imagePath);
            ImageIcon imagen;
            
            if(imagePath.isEmpty() || !archivo.exists() ) {
                imagen = new ImageIcon("src/view/img/libros/libro-default.jpg");   
            } else {
                imagen = new ImageIcon("src/view/img/libros/" + imagePath);   
            }
